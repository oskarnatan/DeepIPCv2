...
from log.xr20_segdep_seq1.config import GlobalConfig #pakai config.py yang dicopykan ke log
# import random
# random.seed(0)
# torch.manual_seed(0)
...
def test(data_loader, model, config):
    ...
    with torch.no_grad():
        ...
        for data in data_loader:
            ...
            steering, throttle, meta_pred = model.mlp_pid_control(pred_wp, lr_velo[-1], pred_steering, pred_throttle)
            ...
            meta_pred['cmd'] = int(data['cmd'].item())
